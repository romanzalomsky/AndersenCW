...
class CharacterLoaderStateAdapter :
    LoaderStateAdapter<ItemCharacterBinding>(ItemCharacterBinding::inflate)

class EpisodeLoaderStateAdapter :
    LoaderStateAdapter<ItemEpisodesBinding>(ItemEpisodesBinding::inflate)

class LocationLoaderStateAdapter :
    LoaderStateAdapter<ItemLocationsBinding>(ItemLocationsBinding::inflate)